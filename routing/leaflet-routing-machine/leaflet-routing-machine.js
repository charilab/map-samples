        ...
        'ja': {
            ...
            instructions: {
                ...
                'WaypointReached':
                    ['経由地到着'],
                'Roundabout':
                    ['ラウンドアバウトを{exitStr}方面へ抜け', '{road}へ'],
                'DestinationReached':
                    ['目的地に到着'],
                'Fork': ['交差点を{modifier}し', '{road}へ'],
                'Merge': ['{modifier}し', '{road}に合流'],
                'OnRamp': ['ランプを{modifier}し', '{road}に乗る'],
                'OffRamp': ['ランプを{modifier}して降り', '{road}へ'],
                'EndOfRoad': ['突き当たりを{modifier}', '{road}へ'],
                'Onto': '{road}を進む'
            },
            formatOrder: function(n) {
                return n + '番目';
